...
import apps.plinqdevelopers.evercast.databinding.FragmentWeatherRainBinding
import apps.plinqdevelopers.evercast.ui.weather.adapters.WeatherForecastAdapter
import apps.plinqdevelopers.evercast.ui.weather.sun.WeatherSunFragmentArgs
...
@AndroidEntryPoint
class WeatherRainFragment : Fragment() {
    private var _binding: FragmentWeatherRainBinding? = null
    private val binding get() = _binding!!

    private val rainViewModel: RainViewModel by viewModels()
    ...
    override fun onCreateView(
        ...
        _binding = FragmentWeatherRainBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val arguments = navArgs<WeatherRainFragmentArgs>()
    ...
    private fun loadWeatherForecast(lat: String, long: String, weatherID: String) {
        binding.apply {
            lifecycleScope.launch {
                rainViewModel.appPreferences.collect { preference ->
                    val accountID: String = preference.accountID

                    val response = rainViewModel.loadForecast(
